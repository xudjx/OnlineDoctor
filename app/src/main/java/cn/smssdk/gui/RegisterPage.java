...
public class RegisterPage extends FakeActivity implements OnClickListener {
	...
	public void onCreate() {
		...
		resId = getIdRes(activity, "service_protocol_tv");
		TextView service_protocol_tv = (TextView)activity.findViewById(resId);
		service_protocol_tv.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG);//下划线
		service_protocol_tv.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent();
				intent.setClass(getContext(), ServiceProtocol.class);
