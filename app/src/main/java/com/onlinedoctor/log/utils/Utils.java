 ...
 */
package com.onlinedoctor.log.utils;
...
public final class Utils {
	...
	public static File getAppCacheDir(Context context, String subName) {
		...
		String appDir = MyApplication.context.getExternalFilesDir(null).getAbsolutePath();
		//File sd = Environment.getExternalStorageDirectory();
		//File dir = new File(sd, getAppName(context));
		File sub = new File(new File(appDir), subName);
		sub.mkdirs();
		return sub;
	}
	...
	public static String getAppName(Context context) {
		if (TextUtils.isEmpty(sAppName)) {
			sAppName = "com.onlinedoctor.activity";
			try {
