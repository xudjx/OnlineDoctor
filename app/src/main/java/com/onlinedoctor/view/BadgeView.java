...
public class BadgeView extends TextView {
     ...
     * {@link android.view.View}.
     *
     * @param badgePosition 指定相对target的位置，默认是 POSITION_TOP_RIGHT
     */
    public BadgeView(Context context, View target, int badgePosition, int marginDip) {
        super(context, null, android.R.attr.textViewStyle);
        init(context, target, 0, badgePosition, marginDip);
    }
    ...
    private void init(Context context, View target, int tabIndex, int badgePosition, int marginDip) {
        ...
        badgeMargin = dipToPixels(marginDip);
        badgeColor = DEFAULT_BADGE_COLOR;
