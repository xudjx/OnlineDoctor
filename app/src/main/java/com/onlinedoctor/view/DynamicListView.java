...
public class DynamicListView extends ListView implements android.widget.AbsListView.OnScrollListener {  
    ...
    class StatusView extends LinearLayout {  
        ...
        private String normalString = "下拉加载";
        private String willrefreshString = "松开加载";
        private String refreshingString = "正在加载";
