...
public class FaceRelativeLayout extends RelativeLayout implements OnItemClickListener, OnClickListener {
	...
	public FaceRelativeLayout(Context context, View view) {
		super(context);
		this.context = context;
		Log.i("FaceRelativeLayout: ", "create-1");
		onCreate(view);
	}
	...
	private void Init_View(View view) {
		vp_face = (ViewPager) view.findViewById(R.id.vp_contains);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (!TextUtils.isEmpty(emoji.getCharacter())) {
			...
			SpannableString spannableString = FaceConversionUtil.getInstace().addFace(this.getContext(), emoji.getId(),
					emoji.getCharacter());
